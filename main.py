...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Usa el comando /historico seguido de un año (ej: /historico 2020) para ver los precios mensuales desde Yahoo Finance."
    )
...
async def historico(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"🔍 Buscando precios históricos de BTC en {anio} desde Yahoo Finance...")

    try:
        # Descargar datos históricos mensuales
